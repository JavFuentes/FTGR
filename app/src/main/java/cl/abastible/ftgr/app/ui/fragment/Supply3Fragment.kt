...
import cl.abastible.ftgr.databinding.FragmentSupply3Binding
import cl.abastible.ftgr.app.ui.adapter.Supply3Adapter
import cl.abastible.ftgr.app.ui.base.BaseFragment
import cl.abastible.ftgr.app.ui.viewmodel.Supply3ViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class Supply3Fragment : BaseFragment<FragmentSupply3Binding>() {
    // Inyecta el ViewModel
    private val supply3ViewModel: Supply3ViewModel by viewModels()
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        supply3ViewModel.verifications.observe(viewLifecycleOwner) { verifications ->
            val adapter = Supply3Adapter(verifications, supply3ViewModel, requireContext())
        ...
        binding.btnContinue.setOnClickListener {
            ...
            if (supply3ViewModel.verifications.value!!.any { it.isChecked == 0 }) {
                showQuestionsNotAnsweredDialog()
            } else if (supply3ViewModel.verifications.value!!.all { it.isChecked == 1 }) {
                // Navegar al siguiente fragmento si todas las verificaciones son afirmativas
                findNavController().navigate(R.id.action_supply3Fragment_to_orderDetail3Fragment)
            } else {
    ...
    private fun showWarningDialog() {
        ...
        AlertDialog.Builder(requireContext())
            ...
            .setPositiveButton("SI") { _, _ ->
                ...
                findNavController().navigate(R.id.action_supply3Fragment_to_returnFragment)
            }
    ...
    private fun setUpToolbar(){
        ...
        (activity as AppCompatActivity).supportActionBar?.title = "Pasos seguros de abastecimiento (3)"
    ...
    private fun activateAllSwitches() {
        val adapter = binding.recyclerView.adapter as? Supply3Adapter
    ...
    override fun initBinding(
        ...
        container: ViewGroup?
    ) = FragmentSupply3Binding.inflate(inflater, container, false)
}
