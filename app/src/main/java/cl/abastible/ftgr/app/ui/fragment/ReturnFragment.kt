...
import cl.abastible.ftgr.databinding.FragmentReturnBinding
...
import cl.abastible.ftgr.app.ui.viewmodel.ReturnViewModel
...
class ReturnFragment : BaseFragment<FragmentReturnBinding>() {
    ...
    private fun showOrderReturnDialog() {
        ...
        imagesAdapter = CapturedImagesAdapter(imagesList,
            { position ->
                ...
                this@ReturnFragment.imagesAdapter.notifyItemRemoved(position)
            },
            { imageItem ->
        ...
        btnDialogAccept.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_returnFragment_to_agendaFragment)
            alertDialog.dismiss()
        }
    ...
    private fun setUpToolbar(){
        ...
        (activity as AppCompatActivity).supportActionBar?.title = "Realizar Devolución"
