...
import cl.abastible.ftgr.databinding.FragmentLeaksProtocol2Binding
...
import cl.abastible.ftgr.app.ui.viewmodel.LeaksProtocol2ViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class LeaksProtocol2Fragment : BaseFragment<FragmentLeaksProtocol2Binding>() {
    private val viewModel: LeaksProtocol2ViewModel by viewModels()
    ...
    private fun showOrderReturnDialog() {
        ...
        imagesAdapter = CapturedImagesAdapter(imagesList,
            { position ->
                ...
                this@LeaksProtocol2Fragment.imagesAdapter.notifyItemRemoved(position)
            },
            { imageItem ->
        ...
        btnDialogAccept.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_leaksProtocol2Fragment_to_agendaFragment)
            alertDialog.dismiss()
        }
    ...
    override fun initBinding(
        ...
        container: ViewGroup?
    ) = FragmentLeaksProtocol2Binding.inflate(inflater, container, false)
}
